...
BEGIN
	...
	INSERT INTO INFO (POKE_ID, REG, TIPO, JOGO) VALUES (V_ID, V_REG, V_TIPO, V_JOGO);
	INSERT INTO STATUS (POKE_ID, ATK, DEF, HP, SP_ATK, SP_DEF, SPEED) VALUES (V_ID,
...
SELECT * FROM Pokemon, INFO, STATUS;